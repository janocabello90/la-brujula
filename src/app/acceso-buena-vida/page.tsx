          ...
          <div className="bg-white rounded-2xl shadow-card border border-borde/40 p-8 sm:p-10">
            {resetSent ? (
              <div className="text-center py-4">
                <div className="w-14 h-14 rounded-2xl bg-naranja/10 flex items-center justify-center text-3xl mx-auto mb-4">🔑</div>
                <h2 className="font-heading text-2xl text-negro mb-2">
                  Email enviado
                </h2>
                <p className="text-muted text-sm leading-relaxed">
                  Hemos enviado un enlace para restablecer tu contraseña a{" "}
                  <strong className="text-negro">{email}</strong>. Revisa tu bandeja de entrada.
                </p>
                <button
                  onClick={() => { setResetSent(false); setShowReset(false); setEmail(""); setError(""); }}
                ...
                <div className="flex flex-col items-center gap-2 mt-5">
                  {!isSignUp && (
                    <button
                      ...
                      className="text-xs text-muted/70 hover:text-naranja transition-colors"
                    >
