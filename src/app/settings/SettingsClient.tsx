    ...
    <AppShell>
      <div className="max-w-xl mx-auto">
        ...
        <div className="bg-card rounded-card shadow-card p-6 mb-4">
          <h2 className="text-sm font-semibold text-negro mb-3">Cuenta</h2>
        ...
        {/* API Key */}
        <div className="bg-card rounded-card shadow-card p-6 mb-4">
          <h2 className="text-sm font-semibold text-negro mb-1">API Key de Anthropic</h2>
          ...
          <input
            ...
            placeholder="sk-ant-..."
            className="w-full px-4 py-3 border border-borde rounded-lg bg-crema text-negro placeholder:text-muted-light focus:outline-none focus:border-naranja transition-colors font-mono text-sm mb-3"
          />
          <button
            onClick={saveKey}
            disabled={saving}
            className="bg-naranja text-white text-sm font-medium px-5 py-2.5 rounded-lg hover:bg-naranja-hover transition-colors disabled:opacity-50"
          >
        ...
        {/* Danger zone */}
        <div className="bg-card rounded-card shadow-card p-6 border border-danger/20">
          <h2 className="text-sm font-semibold text-danger mb-2">Zona de peligro</h2>
          <p className="text-xs text-muted mb-3">
          ...
          <button
            ...
            className="text-sm text-danger border border-danger/30 px-4 py-2 rounded-lg hover:bg-danger/10 transition-colors"
          >
            Resetear mi Brújula
          </button>
        </div>
